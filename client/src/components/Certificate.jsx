      ...
      <div className="certificate">
        ...
        >
          ...
          <h4 className="certificate__subhead">
            ...
            сюрпризом для отримувача. Сертифікат включає в себе можливість вибрати саме ту
            послугу, яка на вашу думку задовольнить отримувача. Сертифікат може
            бути на будь-яку суму, починаючи з суми мінімального замовлення.{" "}
          </h4>
          <motion.button
            className="btn-md-bl"
